        ...
        <div className="min-h-screen p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
            ...
            <main className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    {error && (
                        <div className="bg-red-50 text-red-600 p-4 rounded-card border border-red-100 flex items-center gap-2 font-medium text-sm animate-fade-in">
                    ...
                    {!weatherData && !loading && !error && (
                        <GlassCard className="flex flex-col items-center justify-center min-h-[400px] text-center relative overflow-hidden group animate-fade-in">
                            ...
                            <div className="bg-slate-50 p-6 rounded-full mb-6 relative z-10">
                                <Icons.CloudSun size={64} weight="duotone" className="text-slate-400" />
                                <div className="absolute -right-2 -top-2">
                                    <Icons.Sparkle size={24} weight="fill" className="text-primary animate-bounce-slow" />
                                </div>
                            </div>
                            <h3 className="text-xl font-heading font-bold text-slate-800 mb-2 relative z-10">Ready to explore?</h3>
                            <p className="text-slate-500 text-sm max-w-xs leading-relaxed relative z-10">
